...
def delta_cmap():
    ...
    """
    return vispy.color.Colormap([[0.3, 0.0, 1.0],      # синьо-фіолетовий
                      [0.2, 0.1, 1.0],      # плавний перехід
                      [0.1, 0.2, 1.0],      # до синього
                      [0.0, 0.3, 1.0],      # синьо-блакитний
                      [0.0, 0.5, 1.0],      # блакитний
                      [0.0, 0.6, 0.9],      # темний блакитний
                      [0.0, 0.4, 0.7],      # темніший блакитний
                      [0.0, 0.2, 0.4],      # найтемніший блакитний
                      [0.0, 0.0, 0.0],      # чорний (центр)
                      [0.4, 0.2, 0.0],      # найтемніший жовто-оранжевий
                      [0.7, 0.4, 0.0],      # темний жовто-оранжевий
                      [0.9, 0.6, 0.0],      # жовто-оранжевий
                      [1.0, 0.7, 0.0],      # яскравий жовто-оранжевий
                      [1.0, 0.5, 0.0],      # оранжевий
                      [1.0, 0.3, 0.0],      # оранжево-червоний
                      [1.0, 0.1, 0.0],      # плавний перехід
